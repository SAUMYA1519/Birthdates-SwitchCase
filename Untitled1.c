...
int main()
{
    ...
    switch(a)
    {
        case 1:     //  we do not use '1' with the case
                    //  because '1' is a char type value and the variable is of int data type
                    //  therefore we use only case 1. Also, remember to give a space between case and the value
